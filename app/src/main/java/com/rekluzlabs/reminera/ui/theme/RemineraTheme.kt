...
val MutedClay = Color(0xFFD97706)
...
// Cinnamon and cream (aged parchment)
private val CinnamonBackground = Color(0xFFFBF7ED)
private val CinnamonCardSurface = Color(0xFFF5EEDD)
val CinnamonPrimary = Color(0xFFB8895A)
private val CinnamonOnPrimary = Color(0xFF2E2013)
private val CinnamonSecondary = Color(0xFF8B5E34)
private val CinnamonText = Color(0xFF4A3728)
private val CinnamonMutedText = Color(0xFF8B7355)
private val CinnamonDarkBg = Color(0xFF211A12)
private val CinnamonDarkSurface = Color(0xFF2E2418)
private val CinnamonDarkOnSurface = Color(0xFFF0E6D2)
private val CinnamonDarkPrimary = Color(0xFFD4AC78)
private val CinnamonDarkSecondary = Color(0xFFC49A63)

// Dusty rose and copper
private val RoseBackground = Color(0xFFFDF7F5)
private val RoseCardSurface = Color(0xFFFBEAF0)
val RosePrimary = Color(0xFFD4537E)
...
val OlivePrimary = Color(0xFF639922)
...
private val CinnamonCreamLightColorScheme = lightColorScheme(
    ...
    onPrimary = CinnamonOnPrimary,
    primaryContainer = Color(0xFFEDD9B8),
    onPrimaryContainer = Color(0xFF4A3212),
    secondary = CinnamonSecondary,
    onSecondary = Color.White,
    secondaryContainer = Color(0xFFE8D2AE),
    onSecondaryContainer = Color(0xFF3D2A10),
    tertiary = Color(0xFF6B4E2E),
    onTertiary = Color.White,
    outline = Color(0xFFD9CBA8),
    error = Color(0xFFDC2626),
    onError = Color.White
)
...
private val CinnamonCreamDarkColorScheme = darkColorScheme(
    ...
    surfaceVariant = Color(0xFF3D3120),
    onBackground = CinnamonDarkOnSurface,
    onSurface = CinnamonDarkOnSurface,
    onSurfaceVariant = Color(0xFFC9B896),
    primary = CinnamonDarkPrimary,
    onPrimary = CinnamonOnPrimary,
    primaryContainer = Color(0xFF5C4321),
    onPrimaryContainer = Color(0xFFEDD9B8),
    secondary = CinnamonDarkSecondary,
    onSecondary = Color(0xFF3D2A10),
    secondaryContainer = Color(0xFF6B4E2E),
    onSecondaryContainer = Color(0xFFE8D2AE),
    tertiary = Color(0xFFB89468),
    onTertiary = Color(0xFF3D2A10),
    outline = Color(0xFF5C5138),
    error = Color(0xFFFCA5A5),
    onError = Color(0xFF450A0A)
)
